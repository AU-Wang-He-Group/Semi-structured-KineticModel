...
This repository contains code and experimental data for running the Semi-structured kinetic modeling for methanotroph-photoautotroph cocultures (2021) 
...
__WARNING__: functionV7 needs to be downloaded to run the codes at different conditions
all the codes are similar with the same variables and just initial conditions at each codes are different.
...
- __Raw.Data__: multi-year (2010-2014) olive crop production data (in tons) 
